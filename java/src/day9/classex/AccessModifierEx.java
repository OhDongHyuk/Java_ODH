...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		...
		//num3은 접근제어자가 public
		//AccessModifer 클래스와 A 클래스는 같은 패키지에 있는 클래스
		//AccessModifer 클래스와 B 클래스는 다른 패키지에 있는 클래스
		//num3은 접근제어자가 public. 같은 패키지이든 아닌든 상관 없이 사용가능
		a.num3 = 10; //num3에 대봐서 녹색 동그라미가 뜨면 public
		b.num3 = 20;
...
class A{
	...
	int num2;
	public int num3;
	/**클래스 A의 객체 정보 num1을 출력하는 메소드
	 * 매개변수 : 없음 => 이미 알고 있는 내 정보 num1이기 때문에
	 * 리턴타입 : 없음 => void
	 * 메소드명 : print
	 */
	public void print() {//static은 매개변수를 무조건 남겨야함. 
		//num1은 private이기 때문에 같은 A클래스의 메소드에서 호출 될 수 있다.

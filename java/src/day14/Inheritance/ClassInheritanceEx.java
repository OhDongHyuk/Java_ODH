...
public class ClassInheritanceEx {
	...
	public static void main(String[] args) {
		 ...
		 */
		SmartPhone phone1 = new SmartPhone();//객체 생성
...
class Phone{
	...
	//public Phone() {} <= 생성자가 없으면 컴파일 할 때 안보이지만 기본 생성자가 생성됨
	                     //위에 생성자가 생성되어 이제 추가 안됨
}
class SmartPhone extends Phone{
	...
	@Override //이 어노테이션을 추가하면 밑줄에 에러 발생
	public void call(String num) { //String num2); {//이번 오버라이딩이 아니라 오버로딩을 한 것
		System.out.println(num);//내가 전화를 거는 상대방 번호
		//System.out.println("SmartPhone Calling....");//메소드 오버라이딩 부모의 Calling이 SmartPhone Calling으로 바뀜
		super.call(num) ; //System.out.println("Calling...."); 이걸 호출할 때 사용

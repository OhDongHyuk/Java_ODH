...
public class PolymorphismEx1 {
	...
	public static void main(String[] args) {
		...
		remocon1.turnOn(aircon1);//에어컨를 켜는 기능
		...
		remocon2.turnOff(appliance); //이 둘이 합쳐져 A가됨
		
		remocon2.turnOn(tv2);//가전을 켜는 기능 <- A
		remocon2.turnOn(aircon2);//가전을 켜는 기능
		remocon2.turnOn(radio2);//가전을 켜는 기능
		remocon2.turnOff(tv2);//가전을 끄는 기능
		remocon2.turnOff(aircon2);//가전을 끄는 기능
		remocon2.turnOff(radio2);//가전을 끄는 기능

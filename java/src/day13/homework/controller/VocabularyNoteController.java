...
public class VocabularyNoteController {
	...
	private Voca note = new Voca();
	
	//기본 생성자 => 명시적 초기화 까지만 함
	//public VocabularyNoteController() {} 

	public void run() {
		//반복(종료를 선택하기 전까지) => 무조건 한번은 실행 
		int menu;
		do {
			//메뉴 출력
			printMenu();
	...
	private void updateWord() {
		...
		case 3:
			...
			int num2 = sc.nextInt();
			if(!note.deleteMeaning2(title2, num2)) {

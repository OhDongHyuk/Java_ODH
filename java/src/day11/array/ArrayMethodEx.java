...
public class ArrayMethodEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("num1 = " + num1 + ", num2 = " + num2);
		swap(num1, num2);
		System.out.println("num1 = " + num1 + ", num2 = " + num2); //값이 안바뀐다
		...
		//매개변수로 넘겨준 배열의 주소가 메소드 안에서 바뀌면 원본에 영향이 없다
		swap(arr1, arr2);
		System.out.println("===============");
		printArr(arr1);
		printArr(arr2);
		
		//매개변수로 넘겨준 배열의 주소가 아닌 배열의 값이 메소드 안에서 바뀌면
		//원본이 영향을 받음
		swap2(arr1, arr2);
		System.out.println("===============");
		printArr(arr1);
	 ...
	 * 호출한 곳에서 넘겨준 값을 복사해 옴. (복사본으로 메소드 실행) */

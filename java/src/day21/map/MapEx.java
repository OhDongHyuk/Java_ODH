...
public class MapEx {
	...
	public static void main(String[] args) {
		...
		map2.put("abc123", "abc");//키 값이 중복된 정보를 추가
		map2.put("zxc", "abc");
		...
		while(it.hasNext()) {
			...
			String pw = map2.get(id);//여기서 get은 key값을 이용해서 value값을 가져오는 것
			System.out.println("id : " + id + ", pw : " + pw);
		}
		/* 멤버로 key와 value를 가지는 Entry를 이용하여 map에 있는 key, value 값을
		 * Entry 객체 하나에 널어 Set으로 만듬*/
